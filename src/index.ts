...
export class AetherAI {
  ...
  constructor(nodeUrl: string) {
    ...
    this.moduleAddress =
      "0x23306993ed0d0feb8ef9d97cd6853cf54b21ac058a5c2fddda801020cb7c5789";
  }
  ...
  async registerStrategy(
    ...
    try {
      ...
      console.log(
        "View transaction at:",
        `https://explorer.aptoslabs.com/txn/${transaction.hash}?network=devnet`
      );
  ...
  async executeTrade(
    ...
    try {
      const payload = {
        ...
        arguments: [strategyId, Array.from(Buffer.from(action)), amount, price],
      } as Types.EntryFunctionPayload;
  ...
  async updateStrategy(
    ...
    try {
      const payload = {
        ...
        type_arguments: [],
        arguments: [strategyId, Array.from(Buffer.from(newParameters))],
      } as Types.EntryFunctionPayload;
